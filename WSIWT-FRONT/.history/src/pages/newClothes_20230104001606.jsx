...
export default function NewClothes() {
  ...
  const categoryList = {
    ...
    paddedCoat: [{ name: "none", display: "항목이 없습니다." }],
    winter_hat: [{ name: "none", display: "항목이 없습니다." }],
    muffler: [{ name: "none", display: "항목이 없습니다." }],
    gloves: [{ name: "none", display: "항목이 없습니다." }],
    coat: [{ name: "none", display: "항목이 없습니다." }],
    trench_coat: [{ name: "none", display: "항목이 없습니다." }],
    black_tights: [{ name: "none", display: "항목이 없습니다." }],
    skin_tights: [{ name: "none", display: "항목이 없습니다." }],
    blouse: [{ name: "none", display: "항목이 없습니다." }],
    sleeveless: [{ name: "none", display: "항목이 없습니다." }],
    short_sleeve: [{ name: "none", display: "항목이 없습니다." }],
    shorts: [{ name: "none", display: "항목이 없습니다." }],
  };

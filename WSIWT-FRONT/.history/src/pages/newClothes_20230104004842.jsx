  ...
  return (
    <section className="w-full text-center">
      ...
      <form className="">
        ...
        <div className="flex justify-around flex-1 bg-color2 rounded-md p-2 m-2 gap-1">
          <div className="flex flex-col border-2 border-dashed border-color3 rounded-md">

...
export default function Main() {
  ...
  return (
    <section className="flex flex-col items-center bg-fuchsia-200 h-full  ">
      <RegionInfo data={regionQuery.data} />
      <div className="  h-[40rem] rounded-md overflow-y-scroll scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-300  ">
        <Swiper

...
export default function Main() {
  ...
  return (
    <section className="flex flex-col items-center scrollbar-track-teal-900">
      <RegionInfo data={regionQuery.data} />
      <div className="h-[41rem] overflow-auto scrollbar-track-teal-900">
        <Swiper
          className="flex items-center max-w-xs  bg-slate-200 rounded-md scrollbar-track-teal-900 "
          initialSlide={0}
          pagination={{
            clickable: true,
          }}

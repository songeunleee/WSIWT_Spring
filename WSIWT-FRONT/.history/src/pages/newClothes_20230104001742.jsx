...
export default function NewClothes() {
  ...
  const categoryList = {
    ...
    paddedCoat: [{ id: 1, name: "none", display: "항목이 없습니다." }],
    winter_hat: [{ id: 2, name: "none", display: "항목이 없습니다." }],
    muffler: [{ id: 3, name: "none", display: "항목이 없습니다." }],
    gloves: [{ id: 4, name: "none", display: "항목이 없습니다." }],
    coat: [{ id: 5, name: "none", display: "항목이 없습니다." }],
    trench_coat: [{ id: 6, name: "none", display: "항목이 없습니다." }],
    black_tights: [{ id: 7, name: "none", display: "항목이 없습니다." }],
    skin_tights: [{ id: 8, name: "none", display: "항목이 없습니다." }],
    blouse: [{ id: 9, name: "none", display: "항목이 없습니다." }],
    sleeveless: [{ id: 10, name: "none", display: "항목이 없습니다." }],
    short_sleeve: [{ id: 11, name: "none", display: "항목이 없습니다." }],
    shorts: [{ id: 12, name: "none", display: "항목이 없습니다." }],
  };
    ...
    <section className="w-full text-center">
      ...
      <form>
        ...
        {categoryList["main_list"].map((item) => (
          <CategoryItem key={item.name} item={item} clickCategory={ClickMain} />
        ))}
        {main &&

...
export default function NewClothes() {
  ...
  const categoryList = {
    ...
    paddedCoat: [{ name: "none1", display: "항목이 없습니다." }],
    winter_hat: [{ name: "none2", display: "항목이 없습니다." }],
    muffler: [{ name: "none3", display: "항목이 없습니다." }],
    gloves: [{ name: "none4", display: "항목이 없습니다." }],
    coat: [{ name: "none5", display: "항목이 없습니다." }],
    trench_coat: [{ name: "none6", display: "항목이 없습니다." }],
    black_tights: [{ name: "none7", display: "항목이 없습니다." }],
    skin_tights: [{ name: "none8", display: "항목이 없습니다." }],
    blouse: [{ name: "none9", display: "항목이 없습니다." }],
    sleeveless: [{ name: "none10", display: "항목이 없습니다." }],
    short_sleeve: [{ name: "none11", display: "항목이 없습니다." }],
    shorts: [{ name: "none12", display: "항목이 없습니다." }],
  };

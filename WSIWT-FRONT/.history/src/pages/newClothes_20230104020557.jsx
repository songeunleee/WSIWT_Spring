    ...
    <section onSubmit={handleSubit} className="w-full text-center">
      ...
      <form className="flex flex-col">
        <div className="flex justify-center mb-1 items-center">
          <div
            className="flex-1 bg-color1 text-white cursor-pointer rounded-sm hover:brightness-110 p-2 px-4 text-grey"
            onClick={handleClick}
          >
            사진 등록
          </div>
          <div className="flex-1 pl-2 text-sm">* 필수 아님</div>
          <input
            ref={inputRef}
            className="hidden"
            type="file"
        ...
        <div className="flex justify-around bg-color2 rounded-md p-2 my-3 gap-1">

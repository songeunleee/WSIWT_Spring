...
export default function NewClothes() {
  ...
  const categoryList = {
    ...
    paddedCoat: [{ name: null, display: null }],
    winter_hat: [{ name: null, display: null }],
    muffler: [{ name: null, display: null }],
    gloves: [{ name: null, display: null }],
    coat: [{ name: null, display: null }],
    trench_coat: [{ name: null, display: null }],
    black_tights: [{ name: null, display: null }],
    skin_tights: [{ name: null, display: null }],
    blouse: [{ name: null, display: null }],
    sleeveless: [{ name: null, display: null }],
    short_sleeve: [{ name: null, display: null }],
    shorts: [{ name: null, display: null }],
  };

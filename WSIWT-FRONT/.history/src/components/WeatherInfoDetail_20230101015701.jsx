  ...
  return (
    <section className="flex flex-col items-center w-full bg-gradient-to-br from-color1 to-color2 mb-2 py-4 rounded-lg">
      ...
      <div className=" bg-opacity-50 bg-white rounded-tl-md rounded-md flex flex-col p-2 ">
        ...
        <div className="flex items-center justify-center p-1 border-t-2 border-dashed border-color1">
          <BsUmbrella /> 강수확률 {data[4].fcstValue /*강수확률*/}%
        </div>
        <div className="flex items-center justify-center p-1 border-t-2 border-dashed border-color2">
          <SiRainmeter />
          1시간 강수량{" "}
          {
...

        {
          data[6].fcstValue !== "적설없음" && (
            <div className="flex items-center  justify-center p-1 border-t border-dashed border-color2">
              <BsSnow2 />

...
export default function WeatherInfoDetail({ data }) {
  return (
    <section className="flex flex-col items-center w-full bg-gradient-to-t  from-color1 to-color2 mb-2 py-4 rounded-lg px-2">
      <div className="font-bold">
        {moment(data[0].fcstDate).format("yyyy. MM. DD")}
      </div>
      <div className="text-xl font-bold">{time(data[0].fcstTime)}</div>

...
export default function WeatherInfoDetail({ data }) {
  console.log(data);
  return (
    <section className="flex flex-col items-center w-full bg-gradient-to-r from-cyan-500 to-blue-500 mb-2 py-4 rounded-lg">
      <div className="w-48">
        {weatherImg(
          data[0].fcstTime,
      ...
      <div className="">
        ...
        <div className="flex items-center justify-center p-1  bg-slate-50 border-y-1 border-dashed border-gradient-to-r from-cyan-500 to-blue-500">

...
export default function WeatherInfoDetail({ data }) {
  ...
  return (
    <section className="flex flex-col items-center w-full bg-zinc-500 mb-2 py-4 rounded-lg">
      ...
      <div className="">
        <div className="justify-center flex items-center p-1 m-1 mb-0 bg-slate-50 rounded-md">
          <RiWindyLine /> 풍속 {data[1].fcstValue /*풍속*/}
        </div>

        <div className="flex items-center justify-center p-1 m-1 bg-slate-50 rounded-md">
          <BsUmbrella /> 강수확률 {data[4].fcstValue /*강수확률*/}%
        </div>
        <div className="flex items-center p-1 px-2 m-1 bg-slate-50 rounded-md">
          <SiRainmeter />
          1시간 강수량{" "}
          {

...
export default function TimeWeather({ data }) {
  ...
  return (
    <section
      onClick={handleClick}
      className="flex border-t-2 px-3 border-color2 py-2 items-center cursor-pointer hover:ease-in duration-200 hover:scale-102 overflow-x-auto hover:shadow-md"
    >
      <div className=" border-r-2 border-color2 items-center w-20 py-1 pt-2 ">

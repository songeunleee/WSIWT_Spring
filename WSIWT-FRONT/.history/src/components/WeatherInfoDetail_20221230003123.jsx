...
export default function WeatherInfoDetail({ data }) {
  console.log(data);
  return (
    <section className="flex flex-col items-center w-full bg-gradient-to-r from-pink to-blue mb-2 py-4 rounded-lg">
      <div className="w-48">
        {weatherImg(
          data[0].fcstTime,
      ...
      <div className=" bg-opacity-10 bg-slate-50 rounded-tl-md rounded-md">
        <div className="justify-center flex items-center p-1 ">
          <RiWindyLine /> 풍속 {data[1].fcstValue /*풍속*/}
        </div>

        <div className="flex items-center justify-center p-1  border-red-500 border-dashed ">

  ...
  return (
    <div className=" bg-color2 rounded-3xl p-2">
      <div className="flex justify-between items-center">
        <div className="pl-4 mb-1 text-xl font-bold text-color1">MY CLOSET</div>
        <div className="mr-4 mb-1 px-2 text-2xl font-bold text-color5 border-2 border-color1 border-dashed rounded-full ">
          +
        </div>
      </div>

...
export default function Closet({ category, temperature }) {
  ...
  return (
    <section className=" bg-color2 rounded-3xl p-2 mx-2">
      ...
      {isLoading ? (
        <div className="text-lg text-color1 font-bold border-b-2 border-dashed border-color4">
          loading...
        </div>
        ...
        <div className="p-2 rounded-3xl border-2 border-dashed border-color1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 w-full gap-2">
          {user &&
            closetList &&

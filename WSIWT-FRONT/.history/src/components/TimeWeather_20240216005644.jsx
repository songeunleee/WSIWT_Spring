...
export default function TimeWeather({ data }) {
  ...
  return (
    <section
      onClick={handleClick}
      className="flex border-t m-1 border-color3  items-center cursor-pointer hover:ease-in duration-200 hover:scale-102 overflow-x-auto"
    >
      <div className=" bg-stone-200 rounded-full  border-color4   items-center w-20 py-1 pt-2 ">

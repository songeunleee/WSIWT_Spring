...
export default function TimeWeather({ data }) {
  ...
  return (
    <section
      onClick={handleClick}
      className="flex border-t border-color3 p-2 items-center cursor-pointer hover:ease-in duration-200 hover:scale-102 overflow-x-auto"
    >
      <div className=" border-r border-color4 rounded-lg  items-center w-20 py-1 pt-2 ">
